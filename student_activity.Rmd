...
# Football: Performance v. Attendance
...
### Question 1: Points vs. Average Attendance
...
```{r, echo=F}
coef(lm(total_att ~ points, fb))
```



### Question 2: Goals Scored vs. Total Attendance
...
### Question 3: Goal Differential vs. Total Attendance
...
```{r, echo=F}
coef(lm(median_household_income ~ persons_per_household, dat))
```



### Question 2: Poverty and Education
...
### Question 3: Income and Education
